// Register注册表单的js
var text=[
	"此邮箱将是您登录当当网的账号,并将用来接收验证邮件",
	"昵称可由大小写英文字母、数字组成,长度为4-20个字符",
	"密码可由大小写英文字母、数字组成,长度为6-20个字符",
	"重复密码"
]
// onfocus事件的判断
var allinput=document.querySelectorAll(".of input"); //找出所有的input标签
var allp=document.querySelectorAll(".of p");//找出所有p的标签
for(var i=0;i<allinput.length;i++){  //循环找出所有的input标签
	allinput[i].index=i;   //获取当前下标值
	allinput[i].onfocus=function(){  //每个input绑定事件
		this.style.outlineColor="";
		this.style.outlineColor="#7A9CD3";
		this.style.backgroundColor="#87cefa";
		allp[this.index].innerHTML=text[this.index];
		allp[this.index].className="textfs";
		}	
}
//onblur绑定验证 用户名 密码  邮箱对于错事件
var EM,NK,MA,CM;
em.onblur=function(){
      var email=/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/
      if(em.value==""){
            em.style.backgroundColor="";
            em.style.backgroundColor="#f0ffff";
            Em.className="textof";
            Em.innerHTML="电子邮件是必填项,请输入您的Email地址";
            EM=false;
      }else if(!email.test(em.value)){
            em.style.backgroundColor="";
            em.style.backgroundColor="#f0ffff";
            Em.className="textof";
            Em.innerHTML="电子邮箱格式不正确,请输入正确的邮箱格式";
            EM=false;
      }else{
            em.style.backgroundColor="#87BE00f"
            Em.className="texttr";
            Em.innerHTML="";
            EM=true;
      }
...
use.onblur=function(){
      var nc=/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,20}$/
      if(use.value==""){
            use.style.backgroundColor="";
            use.style.backgroundColor="#f0ffff";
            Use.className="textof";
            Use.innerHTML="昵称为必填项,请输入您的昵称";
            NK=false;
      }else if(!nc.test(use.value)){
            use.style.backgroundColor="";
            use.style.backgroundColor="#f0ffff";
            Use.className="textof";
            Use.innerHTML="昵称格式不正确,可有大小写英文字母、数字组成,长度最少为4个字符";
            NK=false;
      }else{
            use.style.backgroundColor="#87BE00f"
            Use.className="texttr";
            Use.innerHTML="";
            NK=true; 
      }
}
pd.onblur=function (){
      ...
      if(pd.value==""){
            ...
            pd.style.backgroundColor="#f0ffff";
            Pd.className="textof";
            Pd.innerHTML="密码为必填项,请输入您的密码";
            MA=false;  
      }else if(!ma.test(pd.value)){
            pd.style.backgroundColor="";
            pd.style.backgroundColor="#f0ffff";
            Pd.className="textof";
            Pd.innerHTML="密码格式不正确,密码可由大小写英文字母、数字组成,长度最少为6个字符";
            MA=false;  
      }else{
            pd.style.backgroundColor="#87BE00f"
            Pd.className="texttr";
            Pd.innerHTML="";
            MA=true; 
      }
...
ps.onblur=function(){
      if(ps.value==""){
            ...
            ps.style.backgroundColor="#f0ffff";
            Ps.className="textof";
            Ps.innerHTML="重复密码为必填项,请重复您的密码";
            CM=false; 
      }else if(!(pd.value==ps.value)){
            ps.style.backgroundColor="";
            ps.style.backgroundColor="#f0ffff";
            Ps.className="textof";
            Ps.innerHTML="密码不一致,重新填写";
            CM=false;
      }else{
            ps.style.backgroundColor="#87BE00f";
            Ps.className="texttr";
            Ps.innerHTML="";
            CM=true;
      }
...
//提交注册绑定事件(有点毛病)
var ph=document.getElementById("ig");
...
var city=document.getElementById("ctiy");
var twon=document.getElementById("town");
province.innerHTML="<option value=--请选择-->--请选择--</option>";
city.innerHTML="<option value=--请选择-->--请选择--</option>";
twon.innerHTML="<option value=--请选择-->--请选择--</option>";
for(var i=0;i<provinceList.length;i++){
	province.innerHTML
	+="<option value="+provinceList[i].name+">"+provinceList[i].name+"</option>"
}
var arr;
province.onchange=function (){
		...
		for(var i=0;i<provinceList.length;i++){
			...
			city.innerHTML+=
			"<option value="+arr[k].name+">"+arr[k].name+"</option>"
		}
		}
		}
}
